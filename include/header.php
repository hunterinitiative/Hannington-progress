...
<body>
    <?php
        $pageTitle = 'Med<span class=" text-yellow-600 font-thin ">!</span>a Point';
        $section = null;
    ...
    <header class=" w-screen md:h-[70vh] xl:h-[55vh] bg-set bg-cover bg-no-repeat flex flex-col justify-between" style="background:linear-gradient(to bottom, rgba(0,0,0,0.8),100%,rgba(0,0,0,0.8)),url('../img/<?php echo $sectionHero; ?>')">
        <div class="container mx-auto flex justify-between items-center px-4 lg:py-4 xl:py-8">
            <div>
                ...
                <span class="text-amber-400 text-xs">med!a point</span>
            </a>
            
            </div>
            <ul class="flex pl-10 lg:space-x-6 xl:space-x-16 text-white font-semibold uppercase ">
                <li class="text-center <?php if($section == "books"){echo "on";}?>"><a href="catalog.php?path=books" class="hover:text-lime-500 hover:underline" >
                ...
                <li class="text-center  <?php if($section == "movies"){echo "on";}?>"><a href="catalog.php?path=movies" class="hover:text-lime-500  hover:underline">
                ...
                <li class="text-center  <?php if($section == "music"){echo "on";}?>"><a href="catalog.php?path=music" class="hover:text-lime-500 hover:underline">
                ...
                <li class="text-center  <?php if($section == "podcast"){echo "on";}?>"><a href="catalog.php?path=podcast" class="hover:text-lime-500  hover:underline">
                ...
                <li class="text-center  <?php if($section == "blog"){echo "on";}?>"><a href="blog.php?path=blog" class="hover:text-lime-500  hover:underline">
                ...
                <li class="text-center  <?php if($section == "suggest"){echo "on";}?>"><a href="suggest.php?path=suggest" class="hover:text-lime-500  hover:underline">
