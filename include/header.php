...
<body>
    ...
    ?>
    <header class=" w-screen h-[80vh] bg-set " style=" background:linear-gradient(to bottom, rgba(0,0,0,0.8),100%,rgba(0,0,0,0.8)),url('../img/<?php echo $sectionHero; ?>') ">
        <div class="flex justify-between items-center px-14 py-4 xl:py-8">
            <div>
                <a href="index.php">
            ...
            <ul class="flex pl-10 space-x-6 xl:space-x-16 text-white font-semibold uppercase ">
                <li class="<?php if($section == "books"){echo "on";}?>"><a href="catalog.php?path=books" >
                ...
                <li class="<?php if($section == "movies"){echo "on";}?>"><a href="catalog.php?path=movies" class="hover:text-blue-300 hover:underline">
                ...
                <li class="<?php if($section == "music"){echo "on";}?>"><a href="catalog.php?path=music" class="hover:text-blue-300 hover:underline">
                ...
                <li class="<?php if($section == "podcast"){echo "on";}?>"><a href="catalog.php?path=podcast" class="hover:text-blue-300 hover:underline">
                ...
                <li class="<?php if($section == "blog"){echo "on";}?>"><a href="blog.php?path=blog" class="hover:text-blue-300 hover:underline">
                ...
                <li class="<?php if($section == "suggest"){echo "on";}?>"><a href="suggest.php?path=suggest" class="hover:text-blue-300 hover:underline">
