...
<body>
    <header class=" w-full h-[50vh] landing-hero bg-contain bg-center">
        <div class="flex justify-between items-center px-14 py-10 container mx-auto">
            <div>
                <a href="index.php">
            ...
            <ul class="flex pl-10 space-x-14 text-white font-semibold uppercase">
                <li><a href="catalog.php?path=books" class="hover:text-blue-300 hover:underline">
                ...
                <li><a href="catalog.php?path=movies" class="hover:text-blue-300 hover:underline">
                ...
                <li><a href="catalog.php?path=music" class="hover:text-blue-300 hover:underline">
                ...
                <li><a href="catalog.php?path=podcast" class="hover:text-blue-300 hover:underline">
                ...
                <li><a href="blog.php" class="hover:text-blue-300 hover:underline">
                ...
                <li><a href="suggest.php" class="hover:text-blue-300 hover:underline">
